...
https://www.journaldev.com/9958/android-navigation-drawer-example-tutorial
      //  username = (TextView) findViewById(R.id.text_user);
        ...
        if(intentLogin.hasExtra(Intent.EXTRA_TEXT)){
            String userid = intentLogin.getStringExtra(Intent.EXTRA_TEXT);
...
*/
        ...
        drawerItem[0] = new DataModel(R.drawable.subscribe, "Subscribe");
        drawerItem[1] = new DataModel(R.drawable.subscribe, "Subscribe2");
        drawerItem[2] = new DataModel(R.drawable.subscribe, "Subscribe3");
